...
| Acétylcholine <br> (Ach) |  | Mémoire | Nicotine |
| GABA |  | Calme l’activité générale du cerveau | Alcool / GHB/ benzodiazépines |
| Glutamate (Glu) |  | Stimule l’activité <br> générale du cerveau | Alcool |
| NorAdrénaline |  | Prépare le corps à fuir/lutter (attention, concentration) | Cocaïne |
| Dopamine |  | Plaisir | Presque toute <br> directement ou indirectement |
| Sérotonine |  | Régulation de l’humeur, plénitude | LSD/antidépresseurs/MDMA |
| Endorphines <br> (opioïdes) |  | Régulation de la <br> douleur physique et psychique | Codéine/Héroïne |
...
| Glutamate | ↑augmente l’activité | ↓ l’activité du cerveau | Bloque fermé les <br> récepteurs du glutamate | ↓ l’activité du cerveau |
...
|---|---|---|---|---:|
| organe : le cerveau. C’est ce que l’on appelle des substances psychotropes | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| cérébrale, les neurotransmetteurs, présente également des limites. Par exemple, | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| sérotonine ou le trouble de l’attention à un déséquilibre de dopamine est | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| antidote, etc) mais elle ne doit pas être extrapolée et n’explique pas tout ! | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| La jonction entre les neurones s’appelle la synapse | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| que le cerveau ne peut rester dans un tel état de plaisir, le neurone 1 va | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| peut aussi être un vendredi soir après une semaine bien chargée, quand vous | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| antidépresseur de type ISRS est dangereuse ? | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| Cette interaction peut conduire à ce que l’on appelle un syndrome | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| \| NorAdrénaline \| \| Prépare le corps à fuir/lutter (attention, concentration) \| Cocaïne \| | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| Un même neurotransmetteur dans le cerveau peut avoir différents rôles. Plus | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| principaux déterminent souvent les effets ressentis et certains risques. | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| prises répétées, la tolérance peut créer un effet inverse. Par exemple un | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| cérébrale, c’est à dire la communication entre les neurones. Cela peut | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| ghb) il y a un risque d’arrêt respiratoire . | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| mouvements, le cycle sommeil/éveil, l’anxiété, la douleur, l’attention et la | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| nous évite de frapper les personnes qui nous énervent, même si cela nous | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |
| s’accentue au fur et à mesure que l’on en consomme. Le phénomène s’appelle la | Bloc 10 - cerveau/synapses/neurotransmetteurs/circuits | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 103-114 |

## Donnees, reperes et categories

| Donnee ou repere detecte | Contexte | Limite documentaire | Pages sources |
|---|---|---|---:|
| l'idée que nous n'utilisons que 10% de notre cerveau, la théorie du cerveau | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Le constructivisme [147] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| l'exemple du striatum, la « zone du plaisir ». Certains affirment [148] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| scientifique menée par l'University College de Londres [149] conclut qu'il | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image027.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Figure 11. Illustration de la dualité (source:dreamstime) | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| [Image reference: image028.png; source export Word: Traité RDR version html_fichiers/image028.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Figure 12. | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Schéma de neurone [150] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image029.jpg] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Figure 13. | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image030.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| 1. L’influx | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Un influx nerveux venant de la langue se dirige vers le neurone 1, pour donner | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image031.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| 2. Libération | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Le neurone 1, qui est malin, a des stocks de dopamine en réserve : les vésicules . | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image032.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| 3. Liaison | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| neurone 2 pour donner le message et générer un influx électrique. | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image033.jpg] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| [Image reference: image034.png; source export Word: Traité RDR version html_fichiers/image034.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| 4. Re capture | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| que le cerveau ne peut rester dans un tel état de plaisir, le neurone 1 va | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Son objectif ? Créer un maximum de stimulation dans le neurone 2. Reprenez | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| la figure 2 et réfléchissez-y 5 min. | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image035.jpg] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Figure 14. | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image036.jpg] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| 1. Éclater | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| [Image reference: image037.png; source export Word: Traité RDR version html_fichiers/image037.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| particularité : pour rentrer dans le neurone 1, la MDMA passe par le canal | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image038.jpg] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| 2. Empêcher | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image039.jpg] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| 3. Empêcher | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| la dégradation [151] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| [Image reference: image040.jpg; source export Word: Traité RDR version html_fichiers/image040.jpg] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| stimuler directement le neurone 2, en se faisant passer pour un | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |
| [Image reference: image041.png; source export Word: Traité RDR version html_fichiers/image041.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 103-114 |

## Images, tableaux, figures, encadres

| Page | Type | Titre visible | Description | Donnees extraites | Importance RDR | Statut |
|---:|---|---|---|---|---|---|
| 105 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 1164x1124. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p105_figure_01_cerveau_synapses_neurotransmetteur.png` | extrait ; a relire |
| 106 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 811x537. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p106_figure_01_cerveau_synapses_neurotransmetteur.png` | extrait ; a relire |
| 106 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 627x632. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p106_figure_02_cerveau_synapses_neurotransmetteur.png` | extrait ; a relire |
| 107 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 754x527. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p107_figure_01_cerveau_synapses_neurotransmetteur.png` | extrait ; a relire |
| 113 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 1007x459. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p113_figure_01_cerveau_synapses_neurotransmetteur.png` | extrait ; a relire |
| 114 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 1073x527. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p114_figure_01_cerveau_synapses_neurotransmetteur.png` | extrait ; a relire |

## Implications CultureRDR

### Donnees utilisables

- Notions et categories du bloc a integrer ulterieurement dans les themes transversaux : Le cerveau et le corps, Le cerveau, Le fonctionnement des synapses, Hacker le système : mécanisme d’action de base des drogues, Différents récepteurs, Point sur les interactions, Les neurotransmetteurs, Les messagers, L’action des drogues, Exemple de l’alcool, Gaba et glutamate, Acétylcholine : pourquoi l’alcool.
...
- Module futur possible : `cerveau/synapses/neurotransmetteurs/circuits`.
...
- Fichier source : `01_source_canonique/09_cerveau_synapses_neurotransmetteurs_circuits.md`.
- Themes futurs : `02_themes_transversaux/07_neurobiologie_synapses_neurotransmetteurs_circuits.md` futur.
