...
- à relire pour validation éditoriale des dialogues et des exemples opérationnels

## Pages sources
- Pages imprimées du traité : p. 29-44.
- Pages PDF correspondantes : p. 30-45.
- Convention documentaire : `page PDF = page imprimée + 1`.
- La page imprimée 29 / PDF 30 contient une frontière avec la fin visuelle du bloc précédent sur les sophismes, puis ouvre le présent bloc avec `Mécanisme de protection psychologique`.
- La page imprimée 45 / PDF 46 ouvre le bloc suivant : `Comprendre la science`.

## Fonction du chapitre dans le traité

Ce bloc prolonge le chapitre sur la création des croyances. Le traité ne se limite pas à identifier les heuristiques, biais et sophismes : il explique pourquoi une correction factuelle peut échouer même lorsque l'information est juste.

La fonction du chapitre est double :

1. décrire les mécanismes qui protègent une croyance, une image de soi, un groupe d'appartenance ou une liberté perçue ;
2. convertir cette analyse en méthode de réduction des risques avec le protocole `BUT – CADRE – FOND – SORTIE`.

Le chapitre fait donc le lien entre psychologie des croyances et pratique RDR : une information exacte doit aussi être formulée dans un cadre psychologiquement tolérable, sinon elle peut produire rigidification, rejet ou polarisation.
...
- séparation personne / comportement ;
- ambivalence ;
- entretien motivationnel ;
- menu d'options ;
- micro-engagement ;
- règle `si... alors...` ;
- protocole `BUT – CADRE – FOND – SORTIE` ;
...
|---|---|---|---|---|
| Remplacer le jugement moral par un langage d'exposition, d'effet et de levier. | Discussion sur une croyance ou un comportement à risque. | Réduire la défensive et rendre l'information recevable. | Ne suffit pas en situation de danger immédiat ou refus d'échange. | p. 31-36 |
| Demander l'autorisation avant de donner des informations. | Relation d'aide, discussion entre pairs, prévention. | Réduire la réactance et maintenir l'autonomie. | À adapter en urgence médicale. | p. 31-32 |
| Dissocier la valeur de la personne et le comportement discuté. | Correction factuelle, consommation répétée, croyance identitaire. | Prévenir l'attaque identitaire. | Ne transforme pas automatiquement une croyance. | p. 32, p. 35-36 |
| Faire émerger l'ambivalence plutôt qu'argumenter frontalement. | Usage maintenu malgré connaissance partielle du risque. | Susciter des raisons personnelles d'ajustement. | Effets moyens décrits comme modestes et variables. | p. 32-33 |
| Proposer un menu d'options réalistes. | Réduction de risque sans exigence d'arrêt complet. | Permettre un choix faisable. | Les options dépendent de la substance et du contexte. | p. 33, p. 37 |
| Utiliser des micro-engagements mesurables. | Passage de l'intention générale à l'action. | Rendre la décision vérifiable et révisable. | Ne doit pas devenir une prescription médicale personnalisée. | p. 33 |
| En cas de malaise en festival, prioriser stabilisation et critères d'escalade plutôt que débat causal. | Malaise avec chaleur, MDMA, alcool, stress de groupe. | Réduire le risque immédiat et éviter redrop / alcool / excitants / isolement. | Appel médical si signaux graves ou aggravation. | p. 41-42 |

## Données, repères et catégories

### Mécanismes défensifs

| Catégorie | Fonction | Exemple bref |
|---|---|---|
| Dissonance cognitive | Réduire l'inconfort entre comportement et information de risque. | `je consomme` vs `cela augmente un risque`. |
| Raisonnement motivé | Défendre une conclusion compatible avec comportement ou image de soi. | `cela m'aide, donc c'est inoffensif`. |
| Protection de l'identité | Préserver groupe, statut ou image personnelle. | `chez nous, c'est normal`. |
| Réactance | Rejeter ce qui menace l'autonomie perçue. | `j'ai le droit`, rejet du ton. |

### Conditions de correction d'une croyance

- raisonnement valide ;
- données robustes ;
- échange psychologiquement tolérable.

### Signaux d'escalade médicale dans l'exemple de festival
...
- aggravation malgré repos au frais.
...
|---|---|---|---|
| Croyance actionnelle | Catégoriser une croyance qui modifie dose, fréquence, contexte ou précaution. | p. 35-37 | Ne pas inférer sans formulation explicite. |
| Paramètres minimaux du risque | Champs : dose, fréquence, effet, contexte, vulnérabilités, mélanges. | p. 36 | Ne pas trancher si non renseigné. |
| Menu de leviers | Réduire, espacer, sécuriser, éviter mélange, tester, consulter. | p. 33, p. 37 | Adapter à la substance. |
| Signaux d'escalade festival | Déclencheurs d'orientation vers équipe médicale. | p. 41-42 | Validation médicale avant automatisation. |
...
|---|---|---|---|---|---|---|---|---|---|
| B4-R01 | Communication RDR | Si une croyance est actionnelle, demander dose/fréquence/contexte/effet avant conclusion. | `sans risque`, `je gère`, `naturel`, `bon produit`. | Substance, dose, fréquence, contexte, effet. | `On ne peut pas conclure sans préciser dose, fréquence, effet et contexte.` | p. 35-37 | élevé | Ne remplace pas analyse substance. | Ne pas trancher sans données. |
| B4-R02 | Réactance | Si le message peut être perçu comme injonctif, reformuler en options. | opposition au ton, `j'ai le droit`. | options faisables. | `On peut raisonner en options plutôt qu'en injonction.` | p. 31-33 | moyen | UX à valider. | Ne pas infantiliser. |
| B4-R03 | Malaise festif | Si signaux graves, orienter vers équipe médicale / secours. | signaux listés ci-dessus. | symptômes, contexte, état de conscience, respiration. | `Appelle l'équipe médicale maintenant ; ne laisse pas la personne seule.` | p. 41-42 | élevé | Validation médicale requise. | Ne pas diagnostiquer. |

### Messages candidats

| ID | Domaine | Niveau | Condition | Message court | Action proposée | Source | À ne pas dire |
|---|---|---|---|---|---|---|---|
| B4-M01 | Communication | neutre | Discussion sur risque | `On ne parle pas de faute, mais de niveau de risque.` | Préciser dose, fréquence, contexte. | p. 31 | `Tu te mens.` |
| B4-M02 | Ambivalence | accompagnement | Bénéfice et inquiétude coexistent. | `Qu'est-ce que ça t'apporte, et qu'est-ce qui t'inquiète parfois ?` | Faire émerger un levier choisi. | p. 32-33 | `Tu devrais arrêter.` |
| B4-M03 | Sortie actionnable | décision | Changement complet irréaliste. | `Si tu voulais seulement baisser le risque cette semaine, quelle option est faisable ?` | Réduire, espacer, sécuriser, éviter mélange, tester, consulter. | p. 33, p. 37 | `Tout ou rien.` |

### Modules Académie candidats

| ID | Thème | Module candidat | Objectif pédagogique | Notions à couvrir | Source | Priorité | À ne pas faire maintenant |
|---|---|---|---|---|---|---|---|
| B4-A01 | Croyances | Pourquoi les faits ne suffisent pas | Comprendre dissonance, raisonnement motivé, identité, réactance. | 4 mécanismes, signaux de défense, leviers. | p. 29-34 | haute | Ne pas psychologiser l'utilisateur. |
| B4-A02 | Méthode RDR | BUT – CADRE – FOND – SORTIE | Donner une méthode courte pour discuter d'une croyance actionnelle. | 3 conditions, 4 étapes, sortie actionnable. | p. 34-44 | haute | Ne pas convertir en script rigide. |
| B4-A03 | Situations terrain | Discussion, dîner, stand RDR | Montrer l'adaptation au contexte social. | Cannabis, alcool, festival, critères d'escalade. | p. 37-42 | moyenne | Ne pas faire croire que les dialogues sont des protocoles cliniques. |

### Points à ne pas automatiser sans validation

- Diagnostiquer dissonance, déni, raisonnement motivé ou réactance chez un utilisateur.
- Étiqueter directement un utilisateur comme `biaisé`, `dans le déni` ou `en dissonance`.
- Donner un conseil médical personnalisé en cas de malaise.
- Prioriser automatiquement des signaux d'urgence sans validation médicale.
- Utiliser des scripts trop directifs qui augmenteraient la réactance.

## Incertitudes et limites

- Les dialogues sont pédagogiques et mélangent conversations réelles et fictionnelles ; ils ne sont pas des protocoles universels.
- L'entretien motivationnel est cité avec nuance : effets moyens modestes et variables.
- La page 29 contient une frontière avec le bloc précédent.
- Le bas de l'infographie p. 44 est à relire dans l'image source.
- Les signaux d'escalade du malaise festif doivent être validés médicalement avant toute automatisation.

## Renvois internes

- `01_source_canonique/02_mythes_croyances_heuristiques_biais_sophismes.md`
- `01_source_canonique/04_comprendre_science_preuves_causalite.md`
- `02_themes_transversaux/03_croyances_biais_sophismes_decision.md`
- `02_themes_transversaux/26_communication_pairs_entourage_professionnels.md`
- `02_themes_transversaux/27_messages_rdr_terrain_ton_operationnel.md`
