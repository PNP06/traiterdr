...
| Réponse neurobiologique | Libère de la dopamine, mais <br> l'effet diminue rapidement sans changements durables. | Perturbe durablement les <br> circuits de récompense, avec des changements structurels et fonctionnels. |
| Syndrome de <br> sevrage | Pas de symptômes <br> de manque persistants, seulement un stress lié à l'absence de récompense <br> gustative -sucre ou édulcorant- | Provoque un <br> syndrome de sevrage marqué avec des symptômes physiologiques et <br> comportementaux. |
| Effet pharmacodynamique | Pas d'effet pharmacologique <br> direct sur le cerveau, agit comme source d'énergie et plaisir gustatif. | Effets directs sur les <br> récepteurs neuronaux, modifiant durablement le fonctionnement du cerveau. |
| Comportement <br> en cas de punition | Les rats cessent <br> de consommer s'il y a une punition (ex : choc électrique). | Les rats continuent de consommer malgré une punition, <br> montrant une forte dépendance. |
...
| Mécanisme <br> d’action | Mécanisme primaire : Inhibition <br> sélective de la recapture de la sérotonine (5-HT) Mécanismes secondaires <br> possibles | Inhibition de la recapture <br> de plusieurs neurotransmetteurs (sérotonine, noradrénaline, dopamine) Possible <br> action sur d’autres récepteurs (GABA, glutamate, etc.) -mécanisme mal connu - |
| Contrôle de <br> la composition | Strictement <br> contrôlé par les autorités de santé | Variable selon <br> la plante, la méthode de culture, la partie utilisée et le procédé <br> d’extraction |
| Preuves <br> d’efficacité | Efficacité bien documentée <br> par de nombreuses études cliniques | Efficacité reconnue dans <br> certains cas de dépression légère à modérée, mais consensus médical moins <br> solide |
| Interactions <br> médicamenteuses | Interactions <br> possibles mais peu nombreuses | Très nombreuses <br> interactions (anticoagulants, contraceptifs oraux, antiviraux, etc.), pouvant <br> diminuer ou altérer l’efficacité d’autres traitements |
| Effets <br> secondaires | Troubles <br> gastro-intestinaux, céphalées, dysfonctions sexuelles, etc. | Photosensibilité, troubles <br> digestifs, agitation, risque d’interactions multiples |
| Encadrement <br> médical | Nécessaire <br> (prescription médicale) | Usage souvent <br> en automédication, moins d’encadrement et de surveillance |
| Recommandations <br> officielles | Recommandés en première ou <br> deuxième ligne pour la dépression majeure | Généralement non <br> recommandés en première intention, surtout dans la dépression modérée à <br> sévère, à cause des nombreuses interactions |
| Prix & <br> accessibilité | Remboursés | En vente libre, prix variable |
...
| Toxicité du produit seul | Plante de tabac : contient du polonium 210, un élément <br> radioactif | Nicotine pure : aucun problème connu | Nicotine pure : aucun problème connu |
| Toxicité des ajouts | Additifs (ammoniac, insecticides, etc.) | Adjuvants inertes | Glycérine, propylène <br> glycol, arômes alimentaires ; risque si la mèche brûle |
...
| Cannabis | 8–15 % | Jusqu’à 20–30 % chez usagers <br> quotidiens |
| Cocaïne (snif) | 15–25 % | Progression souvent rapide |
| Amphétamines (hors <br> méthamphétamine) | 10–20 % | Données populationnelles |
...
|---|---|---|---|---:|
| de santé, elle risque (grossièrement) un surpoids morbide causant des problèmes | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| Pour la personne ayant une addiction à l’alcool, les risques sont beaucoup plus | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| un facteur qui peut être aggravant en rajoutant des conséquences négatives | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| (nutriment essentiel à la vie, notamment au fonctionnement du cerveau) peut | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| conditions artificielles : un accès intermittent et limité au sucre après une | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| il redevient disponible, manifestant certains signes qui rappellent une | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| davantage lié au stress de ne pas retrouver la récompense gustative attendue | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| superficiels. Le sucre n’entraîne pas l’intensité ni la persistance | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| appelle couramment « addiction au sucre » semble davantage relever d’un | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| somme, l'étude conclut qu'il est prématuré et potentiellement dangereux | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| les recommandations de politique publique, surtout en la comparant à | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| minimiser les risques et dommages en plaçant le sucre au premier plan. | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| le domaine des drogues, où la perception de la naturalité peut fausser la | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| compréhension de la toxicité et des risques associés. | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| l'idée que le synthétique est dangereux. | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| produit dangereux, négligeant la maxime toxicologique essentielle selon | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| synthétique est toujours dangereux, indépendamment du niveau d'exposition. | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| sur le sophisme de l'appel à la nature [82] , | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| Cette chimiophobie peut engendrer des décisions néfastes | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| considérer les champignons hallucinogènes comme moins risqués que le LSD, alors | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| et puisse conduire à des choix risqués pour la santé. | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| une molécule extraite d’une fleur, souvent recommandé par des pharmacies à des | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| fréquemment sur les recommandations de groupes ou d’associations d’allaitement, | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| Par ailleurs, l’ Organisation mondiale de la santé (OMS) déconseille | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| persiste : il est recommandé de l’appliquer directement sur la poitrine et dans | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| Des alternatives thérapeutiques validées par des | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| des produits de synthèse. Malgré ces recommandations, certaines pharmacies et | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| infondée, peut entraîner des situations à risques , où les précautions | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| Le biais de naturalité n’épargne pas les professionnels de | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| santé, ce qui aggrave son impact. Lorsqu’un produit naturel est recommandé sans | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| prendre en compte ses études toxicologiques, des risques réels et méconnus | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| peuvent affecter des patients. La sécurité objective doit toujours primer sur | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| « thérapeutiques » ou « chamaniques » et bénéficie d’une popularité croissante | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| Cette recette de base peut faire l’objet d’adaptation avec | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |
| doses précises et réduire les risques d’effets secondaires graves liés à | Bloc 7 - sucre/naturel/reste perche/contact/addiction | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 70-90 |

## Donnees, reperes et categories

| Donnee ou repere detecte | Contexte | Limite documentaire | Pages sources |
|---|---|---|---:|
| cardiovasculaires et à un diabète de type 2 (s’il y a un terrain propice). | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| nombreux, à commencer par la toxicité. Plus de 70 maladies peuvent être | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| étude récente intitulée "Sugar addiction: the state of the science [76] " | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| comment ont été conditionnés les rats [77] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| Tableau 8. | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| Pour finir, lors du 8ème Congrès sur les Addictions (E-ADD | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| 2024), qui s'est tenu le 19 mars 2024, une conférence [78] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image010.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image010.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| jugement concernant les substances chimiques [79] : | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| les substances chimiques [80] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| 70% des personnes interrogées ne sont pas conscients que la | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| 81% des personnes interrogées, pensent qu’un composé chimique | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| sur le sophisme de l'appel à la nature [82] , | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| comme La Leche League France [83] , | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| plusieurs études animales depuis les années 70 [84] . | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| composée principalement de deux plantes [85] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| d’antidépresseurs historiquement utilisée, mais utilisés aujourd’hui en 3 ou 4 ème | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| a causes de leurs effets secondaires [86] . | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| telles que l’hyperforine et l’hypéricine [87] , | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| \| Mécanisme <br> d’action \| Mécanisme primaire : Inhibition <br> sélective de la recapture de la sérotonine (5-HT) Mécanismes secondaires <br> possibles \| Inhibition de la recapture <br> de plusieurs neurotransmetteurs (sérotonine, noradrénaline, dopamine) Possible <br> action sur d’autres récepteurs (GABA, glutamate, etc.) -mécanisme mal connu - \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| Tableau 9.Comparaison des ISRS avec le Millepertuis | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| (Tryptamines I Have Known And Loved [88] ), | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| section consacrée à la molécule 4-HO-DET : | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| psilocine en ajoutant un groupe hydroxyle en position 4 de la molécule grâce à | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| 4-hydroxylase". Vous introduisez de la DMT, vous obtenez de la 4-hydroxy-DMT, | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| vous obtiendriez de la 4-hydroxy-Mickey Mouse. C'est comme si la psyché du | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| position 4 toutes les tryptamines qu’elle rencontre. | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| l'hydroxyliser en 4-hydroxy-N,N-diéthyltryptamine (4-HO-DET), une drogue | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image018.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| Figure 7.Transformation du THCa en THC | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image019.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| Figure 8. Transformation du GHB (gauche) en GABA (droite) dans l'organisme (par la gaba | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image010.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| base de CBD ne doit pas dépasser 0,3 % [89] . | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| laboratoire via une transformation chimique appelée hydrogénation [90] , | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image010.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| radioactivité naturelle, en particulier le polonium 210, absorbé depuis | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| formulés comme : « Vous verrez dans 30 ans ». Cette prudence peut se | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |
| \| Toxicité du produit seul \| Plante de tabac : contient du polonium 210, un élément <br> radioactif \| Nicotine pure : aucun problème connu \| Nicotine pure : aucun problème connu \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 70-90 |

## Images, tableaux, figures, encadres

| Page | Type | Titre visible | Description | Donnees extraites | Importance RDR | Statut |
|---:|---|---|---|---|---|---|
| 78 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 745x185. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p078_figure_01_sucre_naturel_reste_perche_contact.png` | extrait ; a relire |
| 81 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 256x559. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p081_figure_01_sucre_naturel_reste_perche_contact.png` | extrait ; a relire |
| 89 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 1015x643. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p089_figure_01_sucre_naturel_reste_perche_contact.png` | extrait ; a relire |

## Implications CultureRDR

### Donnees utilisables

- Notions et categories du bloc a integrer ulterieurement dans les themes transversaux : « Addiction » au sucre ?, Naturel = plus sûr ?, Biais de naturalité, Exemple de l’Ayahuasca, Antidépresseur naturel VS synthétique, Une frontière assez fine, Les cannabinoïdes issus du CBD et leurs transformations chimiques, Le milieu et la transformation, Le problème de la combustion (exemple du tabac), Exemple de la fabrication de l’alcool, Fabrication, La qualité : l’alcool frelaté.
...
- Module futur possible : `sucre/naturel/reste perche/contact/addiction`.
...
- Fichier source : `01_source_canonique/06_mythes_sucre_naturel_reste_perche_contact_addiction.md`.
- Themes futurs : `02_themes_transversaux/04_mythes_specifiques_et_recits_sociaux.md` futur ; `23_addiction_dependance_craving_usages_problematiques.md` futur.
