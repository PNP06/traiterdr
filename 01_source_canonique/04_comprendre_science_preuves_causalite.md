...
- extrait provisoire
- phase 1, bloc 5
- contenu source canonique structuré, non validé comme module final
- à relire pour validation de la frontière page 51, car la conclusion du chapitre science continue au début de la page avant le mythe suivant

## Pages sources
- Pages imprimées du traité : p. 45-51 partielle.
- Pages PDF correspondantes : p. 46-52 partielle.
- Convention documentaire : `page PDF = page imprimée + 1`.
- Le sommaire place `Comprendre la science` p. 45-50, mais la conclusion du chapitre continue au début de la page imprimée 51 / PDF 52.
- Le mythe suivant `Le mois sans alcool/sans tabac est inutile` commence ensuite p. 51 / PDF 52 et sera traité dans le bloc 6.

## Fonction du chapitre dans le traité

Ce bloc donne au lecteur la grille méthodologique nécessaire pour comprendre les chapitres de déconstruction des mythes. Il ne vise pas à sacraliser la science, mais à expliquer comment une conclusion robuste est produite, comment l'incertitude est gérée, et pourquoi le niveau de preuve importe davantage qu'un argument d'autorité ou qu'une publication isolée.

Le chapitre prépare notamment les analyses ultérieures sur :

- le verre de vin et la causalité en santé publique ;
- les contradictions apparentes dans les publications ;
- les risques liés aux substances lorsque les effets dépendent de la dose, du contexte, des co-consommations et des vulnérabilités ;
- l'interprétation prudente des résultats d'études.
...
| Recommandation | Contexte | Objectif RDR | Limite | Pages sources |
|---|---|---|---|---|
| Distinguer science et recherche avant d'interpréter un désaccord apparent. | Lecture de publications, débats publics, arguments `scientifiques`. | Éviter de conclure que la science dit tout et son contraire. | La frontière évolue ; nécessite actualisation scientifique. | p. 45-46 |
| Ne pas fonder une conclusion sur une publication isolée. | Argument d'autorité ou étude unique. | Privilégier convergence, reproductibilité et robustesse. | Certaines situations émergentes nécessitent décision avec données limitées. | p. 46 |
| Formuler les risques par conditions plutôt qu'en slogans. | Substances psychoactives, effets cognitifs, toxicologie, santé publique. | Relier risque à dose, contexte, fréquence, produit, population. | Ne donne pas toujours un seuil clair. | p. 48-51 |
| Distinguer association et causalité. | Études observationnelles et exemples cannabis-mémoire, MDMA. | Éviter les inférences abusives. | Les causalités en santé publique peuvent rester probabilistes. | p. 48-51 |
| Traduire les résultats en amplitude, incertitude et conditions. | Lecture de résultats scientifiques. | Éviter le binaire `oui/non`, `dangereux/sûr`. | Exige des données chiffrées parfois absentes du traité. | p. 49-50 |
| Pour le vapotage, retenir une formulation nuancée plutôt qu'un slogan. | Comparaison avec tabac fumé ; non-fumeurs et jeunes. | Réduction de risque chez fumeur en substitution complète ; éviter initiation chez non-fumeurs. | Sujet évolutif ; nécessite mise à jour régulière. | p. 46-47 |
| Pour la MDMA, éviter le binaire `neurotoxique / pas neurotoxique`. | Neurotoxicité, usage important, contexte récréatif. | Raisonner dose, répétition, contexte, co-consommations, hyperthermie. | Ampleur, réversibilité et facteurs individuels restent discutés. | p. 47-48 |

## Données, repères et catégories

### Conditions d'entrée dans le corpus scientifique

| Critère | Fonction |
|---|---|
| Reproductibilité | Tester si le résultat se retrouve. |
| Robustesse | Vérifier si le résultat tient avec méthodes différentes. |
| Traque des biais | Identifier confusion, sélection, mesure imparfaite, causalité abusive. |
| Cohérence biologique | Vérifier la compatibilité avec le fonctionnement du corps et du cerveau, sans en faire une preuve suffisante seule. |
| Convergence | Produire une conclusion stable utilisable avec incertitude bornée. |

### Exemple cigarette électronique

| Point | Formulation prudente |
|---|---|
| Neutralité | Le vapotage n'est pas neutre : exposition à des substances nocives confirmée. |
| Comparaison tabac fumé | Exposition généralement moindre à de nombreux toxiques que la fumée de tabac. |
| Réduction de risque | Pertinente surtout en substitution complète chez un fumeur. |
| Sevrage | Intérêt possible des cigarettes électroniques nicotinées selon certaines synthèses. |
| Jeunes et non-fumeurs | Exposition inutile à la nicotine et risque de dépendance à éviter. |

### Exemple MDMA

| Niveau | Éléments conservés |
|---|---|
| Établi | Libération de sérotonine, effets aigus, augmentation dose-dépendante de la température centrale, hyperthermie sévère en contexte récréatif. |
| Incertain / discuté | Dommage durable du système sérotoninergique chez l'humain, réversibilité, ampleur, facteurs individuels. |
| Facteurs de risque | Dose cumulée, usage important, abstinence, vulnérabilités, co-consommations, chaleur, foule, effort/danse, hydratation inadaptée. |

### Étapes de la méthode scientifique

| Étape | Question associée | Exemple cannabis-mémoire |
|---|---|---|
| Question testable | Qui, quoi, quand, comment ? | Adultes, dose donnée de THC, mémoire de travail, deux heures, placebo. |
| Concepts définis | Que mesure-t-on exactement ? | Mémoire de travail, mémoire épisodique, attention/vitesse de traitement. |
| Plan d'étude adapté | Quel dessin d'étude permet quelle inférence ? | THC vs placebo pour aigu ; observationnel pour durable. |
| Mesure de l'effet | Quelle amplitude, quelle incertitude ? | Taille d'effet, intervalle de confiance, variabilité. |
| Résultats confrontés | Les résultats convergent-ils ? | Populations, doses, produits, délai, co-consommations. |
| Correction collective | Quels garde-fous limitent les biais ? | Protocoles, transparence, réplication, débats. |
...
| Élément | Usage possible | Source | Limite |
|---|---|---|---|
| Niveau de maturité d'une connaissance | Distinguer corpus stabilisé, recherche en cours, incertitude. | p. 45-46 | Demande mise à jour scientifique externe. |
| Type d'étude | Évaluer force d'inférence : expérimental, observationnel, synthèse. | p. 46, p. 49-50 | Le traité ne fournit pas une hiérarchie complète des preuves. |
| Paramètres de risque | Dose, fréquence, contexte, population, co-consommations. | p. 46-51 | À combiner avec chapitres substances. |
| Conditions d'interprétation | Association vs causalité, effet aigu vs durable. | p. 48-51 | Ne pas automatiser une conclusion causale. |
| Incertitude résiduelle bornée | Formuler des messages probabilistes et conditionnels. | p. 46-51 | UX à travailler pour rester compréhensible. |
...
|---|---|---|---|---|---|---|---|---|---|
| B5-R01 | Niveau de preuve | Si l'utilisateur cite une étude isolée, demander le type d'étude et la convergence. | `j'ai vu une étude`, `une publication dit`. | Type d'étude, population, exposition, outcome, synthèses disponibles. | `Une étude seule ne suffit pas ; il faut regarder convergence, méthode et biais possibles.` | p. 45-46 | élevé | Ne pas invalider automatiquement une étude isolée. | Ne pas faire de pseudo-revue systématique automatisée. |
| B5-R02 | Causalité | Si une association est formulée comme causalité, demander facteurs de confusion et plan d'étude. | `X provoque Y` basé sur observation. | Plan d'étude, confounders, temporalité. | `Une association ne prouve pas forcément la causalité.` | p. 49-51 | élevé | Certaines causalités peuvent être inférées par convergence. | Ne pas tomber dans le scepticisme systématique. |
| B5-R03 | Risque contextualisé | Si une affirmation est absolue, reformuler par conditions. | `ça détruit`, `c'est sans danger`, `tout dépend`. | Dose, fréquence, produit, population, contexte. | `La question utile est : chez qui, à quelle dose, dans quel contexte et avec quel effet mesuré ?` | p. 48-51 | élevé | Requiert substance spécifique ensuite. | Ne pas répondre par slogan inverse. |
...
|---|---|---|---|---|---|---|---|---|---|---|
| B5-M01 | Science | pédagogique | Confusion science/recherche | `La science désigne ce qui est stabilisé ; la recherche explore ce qui reste incertain.` | Situer l'affirmation. | `Ce n'est pas le même niveau de maturité.` | `On peut d'abord voir si c'est un acquis ou une question ouverte.` | p. 45-46 | Utile Académie. | `La science a toujours raison.` |
| B5-M02 | Méthode | pédagogique | Affirmation vague sur un effet | `Il faut préciser qui, quoi, quand et comment.` | Transformer en question testable. | `La phrase est trop vague pour conclure.` | `On peut la rendre testable.` | p. 48-49 | Compatible RDR. | `C'est faux parce que trop vague.` |
| B5-M03 | Incertitude | RDR | Données hétérogènes | `Des résultats différents ne veulent pas toujours dire que tout se vaut.` | Comparer population, dose, contexte, méthode. | `Il faut regarder les conditions.` | `On peut chercher pourquoi les résultats divergent.` | p. 46, p. 50 | Réduit polarisation. | `On ne sait rien.` |
...
|---|---|---|---|---|---|---|---|---|
| B5-A01 | Méthode scientifique | Science ou recherche ? | Distinguer corpus établi et recherche en cours. | Étienne Klein, corpus, questions ouvertes, incertitude. | Bloc 4 recommandé. | p. 45-46 | haute | Ne pas transformer en défense idéologique de la science. |
| B5-A02 | Lire une preuve | De l'étude isolée à la conclusion robuste | Montrer pourquoi convergence, robustesse et biais importent. | Reproductibilité, méthodes, confounders, cohérence biologique. | B5-A01. | p. 46 | haute | Ne pas créer de hiérarchie simpliste sans validation. |
| B5-A03 | Cannabis et mémoire | Rendre une question testable | Montrer comment passer d'un slogan à une question mesurable. | Mémoire de travail, placebo, dose, effets aigus/durables. | B5-A01-B5-A02. | p. 48-51 | moyenne | Ne pas conclure au-delà du traité. |
| B5-A04 | MDMA et neurotoxicité | Sortir du binaire | Expliquer comment formuler un risque plausible avec incertitude. | SERT, hyperthermie, dose, contexte, co-consommations. | Chapitres MDMA futurs. | p. 47-48 | moyenne | Ne pas présenter comme monographie MDMA complète. |

### Points à ne pas automatiser sans validation

- Déterminer automatiquement si une connaissance est `science` ou `recherche` sans veille scientifique actuelle.
- Produire des conclusions sur vapotage, MDMA ou cannabis au-delà de ce que le traité dit dans ce bloc.
- Déduire une causalité à partir d'une association sans revue méthodologique.
- Afficher un niveau de preuve chiffré si le traité ne fournit pas de barème explicite.
- Convertir la méthode scientifique en argument d'autorité du type `c'est scientifique donc clos`.

## Incertitudes et limites

- Le bloc mentionne des niveaux de preuve et outils statistiques, mais l'extrait couvert ici ne donne pas encore une grille statistique complète ; à surveiller dans les chapitres ultérieurs.
- La partie `Le mois sans alcool/sans tabac est inutile` commence sur la même page imprimée que la conclusion science ; elle est exclue du présent bloc sauf signalement de frontière.
- Les exemples vapotage et MDMA sont des cas méthodologiques, pas des monographies complètes.
- Les formulations relatives au vapotage peuvent évoluer avec l'état des connaissances ; toute exploitation applicative devra être actualisée.
- Les conclusions sur MDMA doivent rester prudentes : plausibilité, conditions et incertitude bornée, sans bascule vers certitude absolue.

## Renvois internes

- `01_source_canonique/02_mythes_croyances_heuristiques_biais_sophismes.md`
- `01_source_canonique/03_mecanismes_protection_approche_rdr.md`
- `01_source_canonique/05_mythes_alcool_tabac_prix_sante_publique.md`
- `04_substances_mentions/mdma.md`
- `04_substances_mentions/cannabis.md`
- `04_substances_mentions/tabac_nicotine.md`
- `02_themes_transversaux/05_methode_scientifique_preuves_causalite_incertitude.md`
- `03_derives_culturerdr/02_regles_metier_candidates.md`
- `03_derives_culturerdr/03_messages_rdr_candidates.md`
- `03_derives_culturerdr/04_modules_academie_candidates.md`
