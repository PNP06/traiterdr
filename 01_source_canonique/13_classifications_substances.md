...
| Ce que je ressens | Mes pensées s’accélèrent. Je suis plein d’énergie | Mes émotions sont moins fortes (joie et tristesse). Je <br> suis moins motivé. Je suis moins anxieux. | Je suis dans le gaz. J’ai moins <br> mal. | Mes raisonnements sont différents. Mes sens sont modifiés <br> (les couleurs, le touché, la perception du temps) |
...
| Mortalité liée | Mort prématurée à <br> cause de l’usage de la drogue (accident de voiture, cancer, suicide, <br> problème cardiovasculaire) | 6,4 |  |  |
| Maladie spécifique | Maladie directement <br> causée par la drogue (cirrhose, ulcère) | 4,1 |  |  |
| Maladie liée | Maladie à cause de <br> l’usage (MST à cause d’un rapport non protégé, accident domestique) | 4,1 |  |  |
| Psychologique | Dépendance | Dépendance | 5,7 |  |
| Trouble spécifique | Troubles lors de la <br> prise (perte de jugement, agressivité, raisonnements modifiés) | 5,7 |  |  |
| Troubles liés | Troubles liés à <br> l’usage (pertes de mémoire, dépression, psychose) | 5,7 |  |  |
| Sociale | Perte de biens | Perte d’un travail, <br> de son logement | 4,5 |  |
| Perte de relation sociale | Perte de lien avec <br> sa famille et ses amis | 4,5 |  |  |
| Pour les autres <br> (54 points) | Physique <br> Psychologique | Blessures | Blesser les autres <br> directement ou indirectement. Violence, accident de la route. | 11,5 |
| Sociétale | Crime | Risque de commettre <br> un crime (au niveau sociétal et non individuel) | 10,2 |  |
| Environnement | Déchets toxiques <br> des labos de méthamphétamine, seringue usagée | 3,8 |  |  |
| Familial | Difficultés <br> familiales. Négligence des enfants, banqueroute de la famille | 8,9 |  |  |
| International | Déstabilisation <br> politique d’un pays, crime international | 3,8 |  |  |
| Économique | Ensemble des coûts <br> économiques. Santé, police, prisons, services sociaux, perte de productivité, <br> absentéisme, etc. | 12,8 |  |  |
| Communauté | Baisse de la <br> cohésion sociale, déclin de la réputation d’une communauté | 3,2 |  |  |
...
| Tableau II | · <br> Moindre risque d'abus <br> · <br> Largement utilisés à des fins <br> médicales <br> · <br> Codéine | · <br> Risque pour la santé publique <br> · <br> Faible à moyenne utilité <br> thérapeutique <br> · <br> Amphétamine |
| Tableau III | · <br> Préparations <br> contenant des stupéfiants des Tableaux I et II <br> · <br> Usage médical <br> légitime | · <br> Risque pour la santé <br> publique <br> · <br> Moyenne à grande <br> utilité thérapeutique <br> · <br> Diazépam |
| Tableau IV | · <br> Stupéfiants du Tableau I <br> considérés comme particulièrement dangereux <br> · <br> Utilité thérapeutique très <br> limitée <br> · <br> Héroïne | · <br> Faible risque pour la santé <br> publique <br> · <br> Faible à grande utilité <br> thérapeutique <br> · <br> Clonazepam |
...
| Risque | Marge d’Exposition= Dose effet <br> secondaire/dose consommée | Nombre de fois ou la dose consommée doit <br> être prise pour obtenir des effets secondaires |
...
| Alcool (éthanol) | 6 | 26 | 5 | 19 | 56 |
| Opiacés | 8 | 36 | 6 | 1 | 51 |
| Benzodiazépines | 2 | 20 | 10 | 5 | 37 |
| Barbituriques | 4 | 21 | 3 | 5 | 33 |
| Antidépresseurs IMAO (non selectifs) <br> avec médicaments | 22 | 5 | 1 | 2 | 30 |
| Antidépresseurs IMAO (non séléctifs) <br> avec aliments | 28 | 0 | 0 | 0 | 28 |
| Cocaïne | 15 | 6 | 0 | 4 | 25 |
| Caféine | 1 | 6 | 7 | 8 | 22 |
| Cannabis | 5 | 14 | 0 | 1 | 20 |
| Tabac | 0 | 7 | 1 | 9 | 17 |
| Amphétamines | 4 | 2 | 1 | 7 | 14 |
| MDMA ou ecstasy | 4 | 0 | 0 | 7 | 11 |
| Kétamine | 1 | 5 | 1 | 4 | 11 |
| LSD | 6 | 1 | 0 | 1 | 8 |
| Substances volatiles (poppers) | 6 | 1 | 0 | 0 | 7 |
| Méthylphénidate | 2 | 1 | 3 | 1 | 7 |
| Zopiclone | 0 | 3 | 1 | 2 | 6 |
| PCP | 0 | 2 | 0 | 4 | 6 |
...
| --- | --- | --- | --- |
| Alcool | Direct | Violences, agressions sexuelles, comportements à <br> risque | La consommation d'alcool entraine une dérégulation <br> du circuit cérébral du contrôle inhibiteur [267] <br> même pour les personnes tolérantes (dans 40% des viols l’agresseur est <br> alcoolisé [268] ) |
...
| Héroïne et opiacés | Indirect | Vols, vols armés | Les individus dépendants à l'héroïne <br> ont un taux de criminalité sensiblement plus élevé que les consommateurs <br> d'autres substances illicites |
...
|---|---|---|---|---:|
| d'action sur le cerveau et le corps, leur potentiel addictif, leur dangerosité, | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| drogues : stimulantes, neuroleptiques (aussi appelés antipsychotiques), | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| dépresseurs et perturbateurs (anciennement appelés hallucinogènes). | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| effets ressentis, mais cumule les effets secondaires et peut même les | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| peut surprendre, mais il s’agit bien d’un dépresseur du système nerveux. Pour | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| autant, la désinhibition peut conduire à sentir une pseudo stimulation et son | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| pour autant il peut augmenter l’humeur, l’anxiété ou la paranoïa : il peut | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| change la perception de l’environnement, peut distordre la notion de temps, | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| contrôler, bien que difficilement, ses mouvements. Le risque de chute reste | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| considérable, et c’est l’un des dangers bien connus de cette sous-famille [242] . | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| ce que l’on appelle en langage commun un « somnifère ». | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| émotionnel est particulièrement important pour cette classe : le risque | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| dose, ils ont un réel intérêt thérapeutique entre autres pour le | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| dangereuses (fort potentiel addictif, forte potence etc.). | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| sont les drogues les moins dangereuses ? | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| les drogues dangereuses des autres est un enjeu important pour les spécialistes | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| classifications par dangerosité. Parmi les plus connues il y a le rapport | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| À titre d’exemple, cette méthode a été utilisée pour conseiller les | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| Une autre limite concerne le mélange de substances. Ici, | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| Enfin, seuls les dommages sont étudiés ici, alors qu’il peut | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| – Est-ce qu’elle peut provoquer des maladies typiques | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| – Peut-elle provoquer un des troubles psy ? | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| \| Sociétale \| Crime \| Risque de commettre <br> un crime (au niveau sociétal et non individuel) \| 10,2 \| \| | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| est-ce que l’alcool est aussi dangereux que le crack ? Pas vraiment, d’un | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| peut-être, moins de dommages à la société. | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| conseiller les politiques. Nous allons surtout nous intéresser aux dommages | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| Attention : Pour ce classement, le critère « Blessure » n’est | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| rendent une drogue plus ou moins dangereuse . | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| Minimise les risques liés aux usages des drogues | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| risques, cette classification permet d’avoir une première vision générale | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| de la cocaïne peut identifier qu’il risque : | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| possibilité d’avoir une vision globale des risques auxquels vous vous | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| TOUTE PRISE DE SUBSTANCE ENTRAINE DES RISQUES | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| profondeur. Parmi les différentes classifications présentées, on peut citer : | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |
| dose létale d'une substance, mettant ainsi en lumière le risque | Bloc 14 - classifications substances | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 157-181 |

## Donnees, reperes et categories

| Donnee ou repere detecte | Contexte | Limite documentaire | Pages sources |
|---|---|---|---:|
| En 2003, un ingénieur nommé Derek Snider [237] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| a proposé une classification en prenant en compte 4 types d'effets majeurs et | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| 2019 [238] . | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| \| Action \| Stimulation des fonctions psychiques (éveil, activité du <br> cerveau, etc.) \| Aussi appelé Antipsychotique ou <br> « tranquillisant » Neutralité émotionnelle et affective <br> Effet sédatif [239] . \| Diminution des fonctions psychiques. Diminution de <br> l’activité cérébrale et perte de la mémoire. <br> Soulagement de l’anxiété \| Modification de la conscience et de la perception. <br> Souvent, les perturbateurs sont euphorisants. \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| \| Exemple [240] \| Cocaïne \| CBD \| Alcool \| Champignon hallucinogène \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| Tableau 21.Les 4 grands types d'effets des drogues | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| [Image reference: image076.png; source export Word: Traité RDR version html_fichiers/image076.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| Figure 33.Classification simplifiée de Derek Snider | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image010.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| #### Cas particulier du cannabis [241] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| cannabinoïde endogène. Ce dernier est abordé dans le Chapitre 1. | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| [Image reference: image077.png; source export Word: Traité RDR version html_fichiers/image077.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| Figure 34. Principales sous-familles de la classification de Derek Snider | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| considérable, et c’est l’un des dangers bien connus de cette sous-famille [242] . | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| pourrait se traduire par « Dévoilant ou déployant l’âme » [243] . | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| Dans les années 70 la guerre | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| Roques de l’Assemblée Nationale en 1998 [244] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| et celle de David Nutt de 2007 [245] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| (cartographie Dépendances/Dommages utilisé régulièrement dans les forum de RDR) [246] . | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| 2010 puis reprise et validée dans plusieurs pays jusqu’en 2021. | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| QUAND : 2010 | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| (méthode MCDA [247] ) | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| gouvernements sur la gestion des déchets nucléaires [248] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| COMBIEN : 20 substances, 16 critères, | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| 2 séminaires nationaux | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| Royaume-Uni en 2010, mais les travaux ont été repris en 2015 au niveau européen | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| avec la même méthode : cette fois avec 30 spécialistes de 20 pays et les | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| résultats sont similaires [249] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| 1000 publications scientifiques, qui l’utilisent souvent en point de | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| départ, par la Commission globale de politique en matière de drogues en 2019 [250] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| et présentée encore en 2022 dans les cours d’addictologie. D’autres études sur | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| usuelle [251] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| ou par l’étude de consommateurs [252] . | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| critiquée [253] . | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| En comparant la prise de 10 | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| bières contre 1 milligramme de crack, l’alcool pourrait passer pour une drogue | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| considérer les drogues comme des élèves passant un bac. Nous avons donc 20 | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| les chercheurs [254] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| \| Pour soi <br> (46 points) \| Physique \| Mortalité spécifique \| Écart entre dose <br> létale et dose produisant un effet \| 5,1 \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |
| \| Mortalité liée \| Mort prématurée à <br> cause de l’usage de la drogue (accident de voiture, cancer, suicide, <br> problème cardiovasculaire) \| 6,4 \| \| \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 157-181 |

## Images, tableaux, figures, encadres

| Page | Type | Titre visible | Description | Donnees extraites | Importance RDR | Statut |
|---:|---|---|---|---|---|---|
| 160 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 1247x1293. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p160_figure_01_classifications_substances.png` | extrait ; a relire |
| 162 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 889x875. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p162_figure_01_classifications_substances.png` | extrait ; a relire |
| 168 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 1209x986. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p168_figure_01_classifications_substances.png` | extrait ; a relire |
| 169 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 1113x862. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p169_figure_01_classifications_substances.png` | extrait ; a relire |
| 178 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 784x532. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p178_figure_01_classifications_substances.png` | extrait ; a relire |

## Implications CultureRDR

### Donnees utilisables

- Notions et categories du bloc a integrer ulterieurement dans les themes transversaux : Classification des substances, Classification selon les types d’effets, Les quatre grandes catégories, Hallucination= Éléphants roses dans mon salon ?, Classification générale de Derek Snider, Limite s, Notion d’antagoniste, Les mélanges, Cas particulier de l’alcool, Cas particulier du cannabis [241], Les sous-familles, Les dissociatifs.
...
- Module futur possible : `classifications substances`.
...
- Fichier source : `01_source_canonique/13_classifications_substances.md`.
- Themes futurs : `02_themes_transversaux/11_classifications_dangerosite_dommages_toxicite.md` futur ; `12_juridique_classifications_risques_et_limites.md` futur.
