...
| --- | --- | --- |
| Antibiotique | Réduit l’activité de l’ALDH | Augmentation de la concentration en Ethanal. Effet <br> désagréable avec des consommations faibles |
| Antidépresseurs <br> de type ISRS (prozac/fluoxétine) | Non connu | Une étude [371] <br> montre des effets négatifs avec ce mélange |
| Antidépresseur IMAO | Interaction avec la tyramine du vin rouge | Élévation BRUTALE de la pression sanguine |
| Antihistaminique <br> de première génération (mal des transports notamment) | Synergie d’effet <br> sédatif | Sédation importante |
| Antihistaminique de deuxième génération (utilisé pour les <br> troubles gastrique) | Réduit l’activité de l’ADH | Augmentation de l’alcoolémie |
| AINS <br> (ibuprofène) | ? | Augmente le risque <br> d’ulcère |
| Aspirine | Possible réduction de la métabolisation de l’alcool | Alcoolémie plus importante |
| Benzodiazépine <br> (valium, alprazolam, diazépam, etc) | -effets similaires <br> -élimination par <br> cytochrome (concurrence pour l’élimination) | -Synergie des effets <br> -Élimination plus longue |
| Opiacés (codéine, morphine etc) | -effets similaires <br> -élimination par cytochrome (concurrence pour <br> l’élimination) | -Synergie des effets <br> -Élimination plus longue |
| Paracétamol | L’alcool augmente <br> la quantité de CYP2E1 qui transforme le paracétamol en molécule très toxique <br> pour le foie [372] | Augmentation importante de la toxicité <br> pour le foie |
| MDMA | L’alcool dérégule le contrôle de température et la MDMA <br> l’augmente | Risque d’Hyperthermie supérieur aux deux <br> substances seules [373] |
| Cocaïne | L’alcool et la <br> cocaïne fusionnent pour créer du cocaéthylène | Le cocaéthylène est hallucinogène et augmente <br> le risque de crise cardiaque |
...
| Synergie <br> renforçatrice | L’effet total est <br> supérieur à la somme des effets des deux substances. | E > A + B | Alcool + diazépam <br> (Valium®) : sédation et dépression respiratoire amplifiées | Potentialisation des <br> effets au site d’action. |
| Antagonisme compétitif | Une entre en compétition réduisant ou annulant son effet partiellement <br> ou totalement. | E = A - B | Naloxone + morphine <br> : la naloxone bloque les effets opioïdes de la morphine | Compétition sur les mêmes récepteurs. |
| Antagonisme non <br> compétitif | Une substance agit sur <br> un site différent pour produire un effet opposé. | E = A - B | Cannabis + <br> Amphétamine : Amphétamine stimule système nerveux, cannabis dépresseur | Action inverse sur un <br> autre site biologique. |
| Antagonisme partiel | Neutralisation partielle des effets d’une substance. | 0<E<A | Insuline + adrénaline <br> : l’insuline diminue l’hyperglycémie sans agir sur les autres effets | Neutralisation d’un effet spécifique. |
| Antagonisme total | Neutralisation complète <br> des effets d’une substance, indépendamment de sa concentration, par blocage <br> irréversible | E = 0 | Flumazénil + <br> benzodiazépines : Le flumazénil bloque entièrement les effets sédatifs <br> des benzodiazépines sur les récepteurs GABA-A. | Blocage complet des <br> actions. |
| Inversion d’action | Une substance provoque un effet inverse à celui attendu. | E = -A | Adrénaline + alcaloïdes de l’ergot : l’adrénaline provoque une hypotension au lieu d’une <br> hypertension | Modification de la réponse biologique. |
...
| --- | --- | --- |
| Cannabis et vitesse de vidange gastrique | Ralentit la vidange gastrique, retardant l’arrivée des substances dans <br> l’intestin. | Retard de l’absorption des médicaments à action rapide, modifiant leur <br> efficacité. |
| Calcium (produits <br> laitiers) et tétracyclines | Le calcium se lie aux <br> tétracyclines, formant des complexes non absorbables. | Diminution de <br> l’absorption des tétracyclines, réduisant leur efficacité contre l’infection. |
| Alcool et érythromycine (antibiotique) | Irritation de la muqueuse gastrique et accélération du transit <br> intestinal. | Temps d’absorption réduit, diminuant potentiellement l’efficacité de <br> l’érythromycine. |
| MDMA et caféine | La caféine augmente la <br> motilité gastro-intestinale, accélérant l’absorption. | Absorption plus rapide <br> et plus complète de la MDMA, amplifiant les effets et les risques. |
| Antiacides (ex. oméprazole) et médicaments acides | Élévation du pH gastrique, diminuant la fraction non ionisée des <br> médicaments acides faibles. | Diminution de l’absorption des médicaments comme l’aspirine, réduisant <br> leur efficacité thérapeutique. |
| Pansements gastriques et médicaments oraux | Création d’une barrière physique tapissant la muqueuse <br> gastro-intestinale. | Blocage partiel ou total de l’absorption des médicaments, entraînant <br> une inefficacité thérapeutique. |
| Ralentisseurs du transit (ex. lopéramide) | Augmentation du temps de contact entre le médicament et la paroi <br> intestinale. | Absorption accrue des médicaments, augmentant leur <br> concentration sanguine et le risque de toxicité. |
...
| CYP2D6 | 2-5% | Métabolise environ 20% des médicaments , notamment <br> les antidépresseurs et analgésiques. |
| CYP2C9 | 5-30% | Impliqué dans le métabolisme des <br> AINS et des anticoagulants . |
| CYP1A2 | 5-15% | Impacté par le tabac et certains antidépresseurs. |
| CYP2E1 | 5-15% | Participe <br> au métabolisme de l’alcool et le paracétamol. |
...
| Ayahuasca (IMAO + <br> DMT) | Monoamine-oxydase (MAO) | Les inhibiteurs de MAO <br> bloquent la dégradation des monoamines, comme la DMT. | Prolongation des effets <br> psychoactifs et risque de syndrome sérotoninergique en cas d’association avec <br> d’autres substances. | DMT |
| Clarithromycine | CYP3A4 | La clarithromycine inhibe le CYP3A4, augmentant la concentration des <br> médicaments métabolisés par cette enzyme. | Risque de toxicité médicamenteuse accrue. | Benzodiazépines, statines |
...
|  | Il y a une synergie : l’effet ressenti est supérieur <br> à la somme des effets des deux substances prises individuellement. <br> Ils ne sont pas <br> susceptibles de causer une réaction indésirable lorsqu'ils sont utilisés avec <br> précaution. Il est toujours nécessaire d’effectuer des recherches <br> supplémentaires avant de combiner ces produits | Alcool + Cannabis |
|  | Les effets synergiques peuvent être imprévisibles. <br> Ces combinaisons ne <br> sont généralement pas physiquement nocives, mais peuvent produire des effets <br> indésirables (incommodités, nausées etc.). Une utilisation extrême peut <br> causer des problèmes de santé physique. Il convient de faire attention lors <br> du choix d'utiliser cette combinaison. | Alcool + protoxyde <br> d’azote |
|  | Il existe un RISQUE IMPORTANT <br> pour la santé lors de la prise de ces combinaisons, il faut les <br> éviter. | Alcool + cocaïne |
|  | Les réactions à ces <br> mélanges sont très imprévisibles. <br> Ces combinaisons <br> sont considérées EXTREMEMENT TOXIQUE et doivent toujours être évitées. | Alcool + Tramadol |
...
| --- | --- | --- |
| Mixtures.info | Fiches explicatives sur les <br> effets et risques, basées sur des sources scientifiques rigoureuses. | Comprendre les effets , les synergies et les risques des mélanges de drogues <br> courantes. |
| Tableau tripSit/Nuit <br> Blanche | Informations rapides et visuelles sur les niveaux de <br> danger des mélanges. Inclut une application mobile. | Une estimation rapide des dangers avant une <br> recherche plus approfondie sur un mélange de substances psychoactives. |
| Drugs.com | Liste détaillée des interactions <br> d’un médicament, avec une classification des niveaux de risque. | Vérifier les interactions <br> entre médicaments , ou entre médicaments et certaines drogues. <br> Voir la liste des interactions <br> pour une substance. |
| Medscape Interaction <br> Checker | Analyse très succincte des interactions pharmacodynamiques <br> et possibles précautions. | Identifier les interactions <br> impliquant des plantes, compléments alimentaires ou médicaments <br> complexes. |
...
|---|---|---|---|---:|
| considérer qu’une seule est responsable de la mort. Ce phénomène s’appelle la polyconsommation . | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| autres. Comme indiqué dans la classification des risques par interaction, | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| fréquentes et représentent l’un des risques majeurs de la consommation de | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| priorités doit être la sensibilisation aux interactions. Pour bien comprendre | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| est également important de comprendre que ces interactions ne se limitent pas | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| \| AINS <br> (ibuprofène) \| ? \| Augmente le risque <br> d’ulcère \| | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| \| MDMA \| L’alcool dérégule le contrôle de température et la MDMA <br> l’augmente \| Risque d’Hyperthermie supérieur aux deux <br> substances seules [373] \| | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| \| Cocaïne \| L’alcool et la <br> cocaïne fusionnent pour créer du cocaéthylène \| Le cocaéthylène est hallucinogène et augmente <br> le risque de crise cardiaque \| | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| présentation des outils de réduction des risques (RDR), exposés en fin de | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| La synergie renforçatrice est particulièrement dangereuse. | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| augmentant le risque de dépression respiratoire , de coma, voire de | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| décès. Ce danger est d’autant plus insidieux que les consommateurs peuvent | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| C’est ce qu’on appelle l’antagonisme . Si cette interaction peut sembler | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| présente néanmoins des risques importants, notamment le phénomène de rebond . | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| Ce phénomène de rebond peut entraîner des | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| comportements à risque, une surconsommation d’alcool ou même une intoxication | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| Quelques exemples d’utilisation thérapeutique : | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| dans certains cas, leur neutralisation peut être temporaire ou partielle, | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| de substances peut transformer un usage jugé « acceptable » en une situation | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| d’urgence médicale. Comprendre ces interactions, anticiper leurs risques et | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| substances peuvent se potentialiser et une dose acceptable peut devenir dangereuse. | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| s’annulent peuvent aussi être dangereuses : c’est l’effet rebond. | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| concurrence . L’une d’elles peut monopoliser les systèmes d’élimination de | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| À l’inverse, le corps peut s’adapter en augmentant la | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| substance doit être absorbée, généralement au niveau de l’estomac ou de | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| \| MDMA et caféine \| La caféine augmente la <br> motilité gastro-intestinale, accélérant l’absorption. \| Absorption plus rapide <br> et plus complète de la MDMA, amplifiant les effets et les risques. \| | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| \| Antiacides (ex. oméprazole) et médicaments acides \| Élévation du pH gastrique, diminuant la fraction non ionisée des <br> médicaments acides faibles. \| Diminution de l’absorption des médicaments comme l’aspirine, réduisant <br> leur efficacité thérapeutique. \| | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| \| Pansements gastriques et médicaments oraux \| Création d’une barrière physique tapissant la muqueuse <br> gastro-intestinale. \| Blocage partiel ou total de l’absorption des médicaments, entraînant <br> une inefficacité thérapeutique. \| | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| \| Ralentisseurs du transit (ex. lopéramide) \| Augmentation du temps de contact entre le médicament et la paroi <br> intestinale. \| Absorption accrue des médicaments, augmentant leur <br> concentration sanguine et le risque de toxicité. \| | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| l’interaction au niveau de l’absorption peut réduire l’efficacité de | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| produire, l’alcool peut occuper les enzymes qui dégrade les médicaments et les | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| drogues, et l’antibiotique peut donc être libre d’agir plus longtemps. | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| peut « éjecter » l’autre et augmenter sa part libre dans le sang, modifiant | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| substances dépendantes ralentit, ce qui peut augmenter leur concentration dans | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |
| le sang. Cette situation peut amplifier leurs effets ou conduire à des effets | Bloc 19 - interactions/melanges | Conserver le point d'attention operationnel sans l'isoler de son contexte. | A relire avant transformation en conseil individualise ou automatisation. | 248-267 |

## Donnees, reperes et categories

| Donnee ou repere detecte | Contexte | Limite documentaire | Pages sources |
|---|---|---|---:|
| comme la 3MMC ou le GHB. Cependant, lorsqu'on examine ces cas dans les revues | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| responsables à eux seuls de plus de 70% des overdoses mortelles. Or, les | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image010.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| médicaments. Le tableau ci-après en présente les raisons [370] . | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| \| Antidépresseurs <br> de type ISRS (prozac/fluoxétine) \| Non connu \| Une étude [371] <br> montre des effets négatifs avec ce mélange \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| \| Paracétamol \| L’alcool augmente <br> la quantité de CYP2E1 qui transforme le paracétamol en molécule très toxique <br> pour le foie [372] \| Augmentation importante de la toxicité <br> pour le foie \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| \| MDMA \| L’alcool dérégule le contrôle de température et la MDMA <br> l’augmente \| Risque d’Hyperthermie supérieur aux deux <br> substances seules [373] \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| Tableau 38. | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| \| Antagonisme partiel \| Neutralisation partielle des effets d’une substance. \| 0<E<A \| Insuline + adrénaline <br> : l’insuline diminue l’hyperglycémie sans agir sur les autres effets \| Neutralisation d’un effet spécifique. \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| \| Antagonisme total \| Neutralisation complète <br> des effets d’une substance, indépendamment de sa concentration, par blocage <br> irréversible \| E = 0 \| Flumazénil + <br> benzodiazépines : Le flumazénil bloque entièrement les effets sédatifs <br> des benzodiazépines sur les récepteurs GABA-A. \| Blocage complet des <br> actions. \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| Tableau 39. Interactions pharmacodynamiques | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| [Image reference: image101.png; source export Word: Traité RDR version html_fichiers/image101.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| Tableau 40. Illustration de l'effet rebond (alcool et cocaïne) | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image010.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| l’intestin [374] . | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| Tableau 41. | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| ###### Abondance des CYP450 | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| des groupes d’enzymes les plus importants est celui des cytochromes P450 [375] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| (CYP), avec des membres comme CYP3A4, CYP2D6, CYP2E1, etc. | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| P450, connues sous le nom de polymorphisme génétique, peuvent affecter la | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| \| CYP3A4/5 \| 15-38% \| Métabolise environ 30% des <br> médicaments . Cible majeure pour les interactions. \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| \| CYP2D6 \| 2-5% \| Métabolise environ 20% des médicaments , notamment <br> les antidépresseurs et analgésiques. \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| \| CYP2C9 \| 5-30% \| Impliqué dans le métabolisme des <br> AINS et des anticoagulants . \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| \| CYP1A2 \| 5-15% \| Impacté par le tabac et certains antidépresseurs. \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| \| CYP2E1 \| 5-15% \| Participe <br> au métabolisme de l’alcool et le paracétamol. \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| Tableau 42. Répartition des CYP dans le foie humain et rôle | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| dans la métabolisation des médicaments [376] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| Description générée automatiquement; source export Word: Traité RDR version html_fichiers/image010.png] | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| pamplemousse [377] . | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| qui inhibent durablement l’enzyme CYP3A4, présente principalement dans | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| 50 % des médicaments. En la bloquant, le pamplemousse empêche ces médicaments | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| La félodipine [378] , | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| influencé par le CYP3A4. | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| fraction (15 %- c’est la biodisponibilité abordée en partie 1) de la dose | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| atteint la circulation sanguine, le reste étant métabolisé par le CYP3A4 dans | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| Un verre de 200-250 ml de jus bu 4 heures avant la prise de | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| félodipine peut multiplier par 4 la concentration sanguine du médicament. | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| \| Pamplemousse \| CYP3A4 \| Les furanocoumarines neutralisent de manière irréversible le CYP3A4 <br> dans l’intestin et le foie. \| Augmentation des concentrations plasmatiques, risque de surdosage. \| Félodipine, simvastatine, ciclosporine, amiodarone \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| \| Clarithromycine \| CYP3A4 \| La clarithromycine inhibe le CYP3A4, augmentant la concentration des <br> médicaments métabolisés par cette enzyme. \| Risque de toxicité médicamenteuse accrue. \| Benzodiazépines, statines \| | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |
| Tableau 43. | Donnee ou repere chiffre present dans le passage source. | A relire dans le PDF avant reutilisation quantitative. | 248-267 |

## Images, tableaux, figures, encadres

| Page | Type | Titre visible | Description | Donnees extraites | Importance RDR | Statut |
|---:|---|---|---|---|---|---|
| 252 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 679x460. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p252_figure_01_interactions_melanges.png` | extrait ; a relire |
| 256 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 591x206. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p256_figure_01_interactions_melanges.png` | extrait ; a relire |
| 261 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 1282x840. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p261_figure_01_interactions_melanges.png` | extrait ; a relire |
| 261 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 1003x926. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p261_figure_02_interactions_melanges.png` | extrait ; a relire |
| 264 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 2520x1362. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p264_figure_01_interactions_melanges.png` | extrait ; a relire |
| 265 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 1167x465. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p265_figure_01_interactions_melanges.png` | extrait ; a relire |
| 265 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 1211x1183. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p265_figure_02_interactions_melanges.png` | extrait ; a relire |
| 266 | image / figure | a confirmer | Visuel extrait depuis le PDF, dimensions 943x841. | Texte visible a controler dans l'image. | Conserver le visuel avec sa page source pour exploitation ulterieure. | `05_assets_visuels/p266_figure_01_interactions_melanges.png` | extrait ; a relire |

## Implications CultureRDR

### Donnees utilisables

- Notions et categories du bloc a integrer ulterieurement dans les themes transversaux : Interactions, mélanges, Exemple de l’alcool, Modes d’interaction, Interactions pharmacodynamiques, Le risque d’overdose, L’effet rebond, Les antidotes, Conclusion, Interactions pharmacocinétiques, Interactions dans l’absorption, Interactions dans la distribution, Interactions dans le métabolisme.
...
- Module futur possible : `interactions/melanges`.
...
- Fichier source : `01_source_canonique/18_interactions_melanges.md`.
- Themes futurs : `02_themes_transversaux/16_polyconsommations_interactions_methodes_analyse.md` futur.
