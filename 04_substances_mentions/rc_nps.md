...
famille traitee via incertitude produit, marche, testing et classifications.

## Sources canoniques utilisees

| Fichier source | Pages imprimees | Fonction source | Termes detectes |
|---|---:|---|---|
| `01_source_canonique/00_front_matter_suivi_remerciements.md` | a verifier | Front matter, suivi, table des matières et remerciements | NPS, RC |
| `01_source_canonique/01_introduction_cadre_objectif_sources.md` | a verifier | Introduction, cadre, objectif et sources | RC |
| `01_source_canonique/02_mythes_croyances_heuristiques_biais_sophismes.md` | a verifier | Mythes, croyances, heuristiques, biais et sophismes | RC |
| `01_source_canonique/03_mecanismes_protection_approche_rdr.md` | a verifier | Mécanismes de protection psychologique et approche RDR | RC |
| `01_source_canonique/04_comprendre_science_preuves_causalite.md` | a verifier | Comprendre la science, preuves, causalité et méthode scientifique | RC |
| `01_source_canonique/05_mythes_alcool_tabac_prix_sante_publique.md` | 51-69 | Mythes alcool, tabac, sante publique et prix | RC |
| `01_source_canonique/06_mythes_sucre_naturel_reste_perche_contact_addiction.md` | 70-90 | Mythes sucre, naturel, reste perche, contact et addiction | RC |
| `01_source_canonique/07_ghb_drogue_du_viol_chemsex_3mmc_rc_nps.md` | 91-98 | GHB, drogue du viol, chemsex, 3-MMC, RC et NPS | nouveaux produits de synthese, NPS, RC |
| `01_source_canonique/08_gestion_des_risques.md` | 99-102 | Gestion des risques | RC |
| `01_source_canonique/09_cerveau_synapses_neurotransmetteurs_circuits.md` | 103-114 | Cerveau, synapses, neurotransmetteurs et circuits | RC |
| `01_source_canonique/10_tolerance_developpement_15_25_corps_humain.md` | 115-125 | Tolerance, developpement 15-25 ans et corps humain | RC |
| `01_source_canonique/11_pk_pd_absorption_distribution_metabolisme_elimination.md` | 126-139 | PK, PD, absorption, distribution, metabolisme et elimination | RC |
| `01_source_canonique/12_psychologie_placebo_nocebo_troubles_psychologiques.md` | 140-156 | Psychologie, placebo, nocebo et troubles psychologiques | RC |
| `01_source_canonique/13_classifications_substances.md` | 157-181 | Classifications des substances | nouveaux produits de synthese, RC |
| `01_source_canonique/14_risques_generiques_sommeil_juridique.md` | 182-184 | Risques generiques, sommeil et juridique | RC |
| `01_source_canonique/15_sexualite_vulnerabilite_consentement.md` | 185-197 | Sexualite, vulnerabilite et consentement | RC |
| `01_source_canonique/16_allergie_convulsions_hydratation_thermie.md` | 198-222 | Allergie, convulsions, hydratation et thermie | RC |
| `01_source_canonique/17_badtrip_overdose.md` | 223-247 | Badtrip et overdose | RC |
| `01_source_canonique/18_interactions_melanges.md` | 248-267 | Interactions et melanges | RC |
| `01_source_canonique/19_testing_analyses_produits_biologie.md` | 268-293 | Testing, analyses produits et biologie | NPS, RC |
| `01_source_canonique/20_descente_sevrage_addiction_dependance.md` | 294-326 | Descente, sevrage, addiction et dependance | RC |
| `01_source_canonique/21_cancer.md` | 327-332 | Cancer | NPS, RC |
...
- Page imprimée 7 / PDF 8 - Remerciements (`01_source_canonique/00_front_matter_suivi_remerciements.md`, p. a verifier)
...
- Page imprimée 12 / PDF 13 — Structure du livre, lecture efficace, approche scientifique et sources (`01_source_canonique/01_introduction_cadre_objectif_sources.md`, p. a verifier)
...
- Références et notes source du bloc (`01_source_canonique/02_mythes_croyances_heuristiques_biais_sophismes.md`, p. a verifier)
...
- 2. Science et recherche (`01_source_canonique/04_comprendre_science_preuves_causalite.md`, p. a verifier)
- 4. Infographie p. 46 — `Science ≠ Recherche` (`01_source_canonique/04_comprendre_science_preuves_causalite.md`, p. a verifier)
...
- `02_themes_transversaux/01_posture_rdr_cadre_legal_ethique.md` - Posture RDR, cadre legal et ethique
...
- `02_themes_transversaux/03_croyances_biais_sophismes_decision.md` - Croyances, biais, sophismes et decision
...
- `02_themes_transversaux/06_gestion_des_risques_gravite_probabilite_barrieres.md` - Gestion des risques, gravite, probabilite et barrieres
- `02_themes_transversaux/07_neurobiologie_synapses_neurotransmetteurs_circuits.md` - Neurobiologie, synapses, neurotransmetteurs et circuits
